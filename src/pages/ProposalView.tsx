    ...
    const fetchProposal = async () => {
      try {
        ...
        const mapped: ProposalData = {
          ...
          venue: matched.venue || '',
          services: (matched.services || []).map((s) => ({
            title: s.title,
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="relative h-screen overflow-hidden mx-[10%] bg-white rounded-lg shadow-lg">
        ...
        <div className="absolute inset-0">
          <img 
            src="/images/GAN00196-Edit-Edit.jpg" 
      ...
      <div className="py-12">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-600 text-white p-6 rounded-lg">
              <h3 className="text-xl font-bold mb-4">13 Aug 2025 - Bride Haldi</h3>
              <div className="space-y-2">
                <p><span className="font-semibold">Photo Crew:</span> 1 Candid, 1 Traditional</p>
                <p><span className="font-semibold">Video Crew:</span> 1 Cinematic, 1 Traditional</p>
              </div>
          </div>
          
            <div className="bg-gray-600 text-white p-6 rounded-lg">
              <h3 className="text-xl font-bold mb-4">13 Aug 2025 - Bride Mehendi</h3>
              <div className="space-y-2">
                <p><span className="font-semibold">Photo Crew:</span> 1 Candid, 1 Traditional</p>
                <p><span className="font-semibold">Video Crew:</span> 1 Cinematic, 1 Traditional</p>
                    </div>
            ...
            <div className="bg-gray-600 text-white p-6 rounded-lg">
              <h3 className="text-xl font-bold mb-4">14 Aug 2025 - Bridal Ceremony</h3>
              <div className="space-y-2">
                <p><span className="font-semibold">Photo Crew:</span> 1 Candid, 1 Traditional</p>
                <p><span className="font-semibold">Video Crew:</span> 1 Traditional</p>
            </div>
              </div>
            
            <div className="bg-gray-600 text-white p-6 rounded-lg">
              <h3 className="text-xl font-bold mb-4">13 Aug 2025 - Groom Events</h3>
              <div className="space-y-2">
                <p><span className="font-semibold">Photo Crew:</span> 1 Candid, 1 Traditional</p>
                <p><span className="font-semibold">Video Crew:</span> 1 Traditional</p>
          </div>
            ...
            <div className="bg-gray-600 text-white p-6 rounded-lg">
              <h3 className="text-xl font-bold mb-4">14 Aug 2025 - Puja 1</h3>
              <div className="space-y-2">
                <p><span className="font-semibold">Photo Crew:</span> 1 Traditional</p>
                <p><span className="font-semibold">Video Crew:</span> 1 Traditional</p>
              </div>
            </div>
            
            <div className="bg-gray-600 text-white p-6 rounded-lg">
              <h3 className="text-xl font-bold mb-4">14 Aug 2025 - Pre Reception</h3>
              <div className="space-y-2">
                <div className="flex items-center mb-2">
                  <span className="bg-white text-gray-600 px-3 py-1 rounded-full text-sm font-semibold mr-2">Drone</span>
                  </div>
                <p><span className="font-semibold">Photo Crew:</span> 1 Candid, 1 Traditional</p>
                <p><span className="font-semibold">Video Crew:</span> 1 Cinematic, 1 Traditional</p>
                    </div>
            ...
            <div className="bg-gray-600 text-white p-6 rounded-lg">
              <h3 className="text-xl font-bold mb-4">14 Aug 2025 - Wedding</h3>
              <div className="space-y-2">
                <div className="flex items-center mb-2">
                  <span className="bg-white text-gray-600 px-3 py-1 rounded-full text-sm font-semibold mr-2">Drone</span>
                  </div>
            ...
            <div className="bg-gray-600 text-white p-6 rounded-lg">
              <h3 className="text-xl font-bold mb-4">18 Aug 2025 - Puja - Bride</h3>
              <div className="space-y-2">
                <p><span className="font-semibold">Photo Crew:</span> 1 Traditional</p>
                <p><span className="font-semibold">Video Crew:</span> 1 Traditional</p>
                      </div>
        ...
        <div className="mb-16">
          ...
          <p className="text-gray-700 text-lg mb-8">
            As per your request, we propose the following Deliverables as part of this package:
          </p>
          ...
          <div className="space-y-4">
            <div className="bg-gray-600 text-white p-6 rounded-lg flex items-start">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2">Raw Footage</h3>
                <p>You shall receive a total Raw Footage of all the events</p>
              </div>
            </div>
            ...
            <div className="bg-gray-600 text-white p-6 rounded-lg flex items-start">
              ...
              <div>
                ...
                <p>Live Streaming for the Wedding</p>
              </div>
            </div>
        ...
        <div className="mb-16">
          ...
          <div className="space-y-4">
            <div className="bg-gray-600 text-white p-6 rounded-lg">
              <h3 className="text-xl font-bold">Advance Payment</h3>
                  </div>
                  </div>
                </div>
          ...
          <div className="space-y-6">
            <div className="bg-gray-100 p-6 rounded-lg">
              ...
              <p className="text-gray-700">
                You shall arrange for the travel, Food and accommodation of our shoot crew for all your events occurring in places away from our offices.
              </p>
                  </div>
            ...
            <div className="bg-gray-100 p-6 rounded-lg">
              ...
              <p className="text-gray-700">
                Apart from Wedding any event is considered as 4-5 hours for additional coverage need to discuss for adding slot
              </p>
                  </div>
                  </div>
                </div>
        ...
        <div className="mb-16">
          <div className="bg-gray-100 p-6 rounded-lg mb-6">
            ...
            <p className="text-gray-700">
              We Clients must request any corrections or changes within 1 week of receiving the final video or album draft. After this period, we will not be responsible for delayed correction requests, and additional charges will apply for any revisions made beyond the 1-week window.
            </p>
                  </div>
          ...
          <div className="bg-gray-100 p-6 rounded-lg mb-8">
            ...
            <p className="text-gray-700">
              We will Strictly adhere to providing only the Requirements listed above, without adding or including any additional elements beyond those specified.
            </p>
                  </div>
