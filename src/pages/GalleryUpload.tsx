      ...
      <div className="min-h-screen bg-gray-50 flex">
        ...
        <div className={`flex-1 transition-all duration-300 ease-in-out ${sidebarCollapsed ? 'ml-16' : 'ml-64'}`}>
          ...
          <main className="pt-16 p-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-4 mb-6">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-3">
                  {selectedItems.length > 0 && (
                    <div className="flex items-center space-x-2">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors duration-200 text-sm disabled:opacity-50"
                      >
                        {deleteLoading.length > 0 ? (
                  ...
                  {selectedItems.length === 0 && filteredImages.length > 0 && (
                    <button
                      onClick={handleSelectAll}
                      className="text-sm text-[#00BCEB] hover:text-[#00A5CF] transition-colors duration-200"
                    >
                      Select All
                    </button>
                  )}
            ...
            {error && (
              <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
                ...
                {deleteErrors.length > 0 && (
                  <div className="mt-2">
                    <h4 className="text-sm font-medium text-red-700">Failed Deletions:</h4>
                    <ul className="mt-1 text-sm text-red-600 space-y-1 max-h-40 overflow-y-auto">
            ...
            {(loading || deleteLoading.length > 0) && (
              <div className="text-center py-12">
                <Loader2 className="h-8 w-8 text-[#00BCEB] animate-spin mx-auto mb-4" />
                <p className="text-gray-600">
                  {deleteLoading.length > 0 ? 'Deleting images...' : 'Loading gallery...'}
                </p>
              </div>
            )}
            ...
            {!loading && !error && (
              <div className="space-y-8">
                ...
                {filteredImages.length > 0 && (
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-lg font-semibold text-[#2D2D2D]">Images</h3>
                              ...
                              <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-40 transition-all duration-200 flex items-center justify-center">
                                <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex items-center space-x-2">
                                  ...
                                  <button 
                                    ...
                                    className="p-2 bg-white text-red-500 rounded-full hover:bg-red-500 hover:text-white transition-colors duration-200 disabled:opacity-50" 
                                    title="Delete"
                                  >
                            ...
                            <div key={item.id} className="p-4 hover:bg-gray-50 transition-colors duration-200">
                              <div className="flex items-center space-x-4">
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  {deleteErrors.some(err => err.Key === item.key) && (
                                    <p className="text-sm text-red-600 mt-1">
                                      Failed to delete: {deleteErrors.find(err => err.Key === item.key)?.Message}
                                    </p>
                                  )}
                                </div>
              ...
              <div className="flex-1 p-6 overflow-y-auto">
                <div className="space-y-4 mb-6">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00BCEB] focus:border-transparent"
                  />
                  ...
                  <div className="flex items-center space-x-6">
                    <label className="flex items-center">
                      <input
                        ...
                        className="mr-2 w-4 h-4 text-[#00BCEB] border-gray-300 rounded focus:ring-[#00BCEB]"
                      />
                  ...
                  {uploadFiles.length > 0 && (
                    <div>
                      <h4 className="font-medium text-[#2D2D2D] mb-2">Files to Upload</h4>
                        ...
                        {uploadFiles.map((file) => (
                          <div key={file.id} className="flex items-center justify-between p-2 bg-gray-50 rounded-lg">
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              {file.status === 'uploading' && <Loader2 className="w-4 h-4 text-[#00BCEB] animate-spin" />}
